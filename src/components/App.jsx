  ...
  return (
    <aside className="sidebar">
      <div className="brand">
        ...
        <div className="wm">Drumbeat<small>WC 2026 Leaderboard</small></div>
      </div>
...
export default function App() {
  ...
  const initialView = (() => {
    ...
    try { const s = localStorage.getItem('drumbeat.view'); if (s && VIEWS.includes(s)) return s } catch {}
    return 'today'
  })()
  ...
  useEffect(() => { try { localStorage.setItem('drumbeat.view', view) } catch {} }, [view])
